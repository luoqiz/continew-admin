...
public class RefreshTokenRequestGuard {
    ...
    public void checkRequestRateLimit(HttpServletRequest request) {
        ...
        String clientIp = request == null ? "unknown" : JakartaServletUtil.getClientIP(request);
    ...
    private URI parseOrigin(String value) {
        ...
        try {
            ...
            if (!("http".equalsIgnoreCase(scheme) || "https".equalsIgnoreCase(scheme))
                ...
                || StrUtil.isNotBlank(uri.getRawPath()) || uri.getRawQuery() != null
                || uri.getRawFragment() != null || port < -1 || port > 65535) {
                return null;
            }
            return uri;
        } catch (IllegalArgumentException e) {
