...
<#--VALUES-->
<#--    (@parentId, '${businessName}管理', ${parentMenuId}, 2, '/${apiModuleName}/${apiName}', '${classNamePrefix}', '${apiModuleName}/${apiName}/index', NULL, NULL, b'0', b'0', b'0', NULL, 1, 1, 1, NOW());-->
...
BEGIN
    ...
    INSERT INTO "sys_menu"
        ("id", "title", "parent_id", "type", "path", "name", "component", "redirect", "icon", "is_external", "is_cache", "is_hidden", "permission", "sort", "status", "create_user", "create_time")
    VALUES
        (sys_menu_id_seq, '${businessName}管理', ${parentMenuId}, 2, '/${apiModuleName}/${apiName}', '${classNamePrefix}', '${apiModuleName}/${apiName}/index', NULL, NULL, false, false, false, NULL, 999, 1, 1, NOW());
